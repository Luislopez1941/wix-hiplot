...
import { bannerData } from "../../../../components/containers/data/bannerData";
import { useEditorBannerStore } from "../../../../zustand/web-page/EditorBanner";
import { useWebStore } from "../../../../zustand/web-page/StoreWebPage";

const Banner = ({ autoPlay = true, showNavigation = true, showDots = true, item, data = bannerData, index }: any) => {
  const { dataEditContainer, currentSlide }: any = useEditorBannerStore();
  ...
  const nextSlide = useCallback(() => {
    ...
    setContainers(data);
    setProgress(0);
  }, [currentSlide, containers, index, item]);



 const prevSlide = useCallback(() => {
  // No decrementar si ya estamos en el slide 0
  const newSlide = currentSlide === 0 ? 0 : currentSlide - 1;

  // No decrementar el index si ya es 0
  const newIndex = dataEditContainer.index === 0
    ? 0
    : dataEditContainer.index - 1;
