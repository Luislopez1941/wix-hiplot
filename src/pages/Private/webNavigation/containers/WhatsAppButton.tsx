...
const contactLocations: ContactLocation[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=150&h=150&fit=crop&crop=center",
  },
  {
    name: "Palenque",
    phone: "+52-999-234-5678",
    image:
      "https://images.unsplash.com/photo-1518638150340-f706e86654de?w=150&h=150&fit=crop&crop=center",
  },
  {
    name: "Xcaret",
    phone: "+52-999-345-6789",
    image:
      "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=150&h=150&fit=crop&crop=center",
  },
  {
    name: "Playa",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=150&h=150&fit=crop&crop=center",
  },
];
              ...
              {contactLocations.map((location) => (
                ...
                >
                  ...
                  <div className="whatsapp-location-info">
                    <span className="whatsapp-icon-text">📱</span>
                    <span className="whatsapp-location-name">
                      {location.name}
                    </span>
                  </div>
                </div>
