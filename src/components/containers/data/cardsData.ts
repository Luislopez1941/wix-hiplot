...
export const cardsData: CardItem[] = [
  ...
  },
  {
    ...
    title: "Soporte 24/7",
    description:
      "Equipo de expertos disponible las 24 horas para resolver cualquier duda o problema.",
    icon: "💬",
    image:
  ...
  },
  {
    ...
    description:
      "APIs documentadas y herramientas que se integran perfectamente con tu stack actual.",
    icon: "🔧",
    image:
